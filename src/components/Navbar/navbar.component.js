...
const NavLg = () => {
    ...
    <div className="container mx-auto px-12 flex items-center justify-between">
        ...
        <span className="text-gray-600 text-xs flex items-center hover:text-white cursor-pointer">
          Chennai
          <BiChevronDown />
         </span>
         <button className="bg-red-600 rounded text-white text-sm px-2 py-1 hover:bg-black hover:text-white">
         Sign in
         </button>
         <div className="w-8 h-8 text-black hover:text-white">
...
const Navbar = () => {
    return (
    <>
    <nav className="bg-navCol-400 px-4 py-2">
